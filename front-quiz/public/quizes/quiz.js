...
let timer;
let timeLeft = 60; // 60 segundos por quiz
...
// Adicione esta função para salvar os resultados no banco de dados
...
// Modifique a função showResults para incluir o salvamento dos resultados
function showResults() {
  clearInterval(timer);
  quizContainer.classList.add('hidden');
  resultsContainer.classList.remove('hidden');
